...
To help make our model more robust, we will try to identify if the features having precievable/obvious inputs are outliers. We will try to to identify the outliers in the data for questions having answers as "Yes" and "No".
To do this we will seperate the interesting data containing only answers:
...
![](Figures/Outliers_Removed.png){width=800px}
...
Cat_ques <- c(0,1,1,1,1,1,2,2,2,0,2,2,2,1,1,1,2,2,2,2,2,2,2,2,2,2,2,2,2,2,
              2,2,1,2,2,2,2,2,1,2,2,2,2,2,2,2,2,2,2,2,2,2,1,1,1,2,2,2,2,1,
