...
We will create an index to help up to quickly identify the variables and create a code to impute the same . We will use MICE package to compute the same.
