...
### Demographic
Among the 32 columns with less than 25% of missing value we have selected eight interesting columns:
...
Among the 88 columns with less than 25% of missing value we have selected sixty-nine interesting columns:
* **ID (SEQN)** - Respondent sequence number.
...
Among the 46 columns with less than 25% of missing value we have selected <which> relevant columns:
